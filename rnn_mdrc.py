...
from model.mdrc import MDRC

# 设置一些参数
data_dir = 'data/dataset/augment/dataset_augment_synonym/'
...
word_or_char = 'word'  # 以词为输入还是以句子为输入
batch_improve_size = 1700  # 多少个batch不更新loss即退出
dropout = 0.1

seed = 1001  # pytorch种子
# shuffle_seed = 1001  # 数据集的打乱种子

# shuffle_seed=101234,epoch=29,batch_improve_size=1500
# dataset best -- shuffle_seed=101234,epoch=22,batch_improve_size=1400
# dataset_augment_synonym best -- shuffle_seed=101234,epoch=29,batch_improve_size=1500
# dataset char --shuffle_seed=1001,--seed=10111198,batch_improve_size=1400,learning_rate=1e-3
# dataset word --shuffle_seed=1001,--seed=1001,batch_improve_size=1400,learning_rate=1e-3
...
# 加载模型
mdrc = MDRC(vocab=embedding,dropout=dropout)
# 判断是否有cuda,是否使用cuda
